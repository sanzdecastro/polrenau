...
<template>
  <div class="media-container pointer-events-none" :class="thumbnail.AspectRatio ? thumbnail.AspectRatio : aspectRatio">
    <video width="100%" height="100%" :poster="'https://res.cloudinary.com/dtsjetrtt/video/upload/q_auto/' + thumbnail.Media.data.attributes.hash + '.jpg'" class="media-animation lazy-video" loop muted autoplay playsinline  v-if="thumbnail.Media.data.attributes.ext === '.mp4'" >
      <!-- 1080p sources -->
      ...
      <!-- 720p sources -->
      <source :src="'https://res.cloudinary.com/dtsjetrtt/video/upload/q_auto/w_720/' + thumbnail.Media.data.attributes.hash + '.webm'" type="video/webm" media="(min-width: 720px)">
      <source :src="'https://res.cloudinary.com/dtsjetrtt/video/upload/q_auto/w_720/' + thumbnail.Media.data.attributes.hash + '.mp4'" type="video/mp4" media="(min-width: 720px)">
      <!-- 480p sources -->
    ...
    <img width="100%" height="100%" loading="lazy" class="media-animation" :src="thumbnail.Media.data.attributes.url" v-if="thumbnail.Media.data.attributes.ext === '.jpg' || thumbnail.Media.data.attributes.ext === '.png'" >
  </div>
</template>
