...
<template>
  <div class="media-container" :class="media.AspectRatio">
    ...
    <video autoplay muted playsinline controls loop controlsList="nodownload" :src="media.Media.data.attributes.url" v-if="media.Media.data.attributes.ext === '.mp4' && media.autoplay === true" class="media-animation"></video>
